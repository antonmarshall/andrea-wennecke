...
const TherapyCard = ({
  ...
  return (
    <div 
      className={`p-6 rounded-lg h-full transition-all duration-300 bg-white/80 backdrop-blur-sm border-l-4 ${borderColor} hover:bg-opacity-90 ${hoverColor}`}
    >
    ...
    <section id="therapy" className="py-20 bg-orange-50">
      <div className="container mx-auto px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl font-bold mb-6 text-therapyBlue">Mein Therapieangebot</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Entdecken Sie meine vielfältigen Therapiemethoden für Erwachsene und Jugendliche.
          </p>
        </div>
        
        <div className="p-8 rounded-lg shadow-md bg-white/80 backdrop-blur-sm border border-orange-200/50">
          <h3 className="text-xl font-semibold mb-8 text-therapyBlue">Therapiemethoden</h3>
